...
@configclass
class RslRlPpoActorCriticPointNetCfg:
    """Configuration for the PPO actor-critic networks with PointNet."""
    ...
    proprioception_space: int = MISSING
    """The size of the proprioception space."""
    
    latent_dim: int = MISSING
    """The latent dimension resulting from the pointnet network."""
